...
>
    ...
    <form style="visibility:hidden" action="tickets.php?id=<?php echo $ticket->getId(); ?>"
        method="post" id="resend" name="resend">
        <?php csrf_token(); ?>
        <input type="hidden" name="a" value="resend">
        <input type="hidden" name="id" value="<?php echo $ticket->getId(); ?>">

        <input type="checkbox" id="rsIncludeThread" name="includeThread" />
        <input type="checkbox" id="rsIncludeCollaborators" name="includeCollaborators" />
        <input type="checkbox" id="rsIncludeQuality" name="includeQuality" /> 
